package com.acme.fulfillment.workflows.v1;
 ...
 *
 * Not yet Worker-Versioned: fulfillment.Order was introduced as its own bounded
 * context but has no deployment-properties/build-id configured yet.
 *
